...
namespace Game.UI.Lobby
{
    ...
    public class HomeTabView : LobbyTabViewBase
    {
        ...
        [SerializeField] private GameObject  _stagePreviewPanel;

        /// <summary>스테이지 진입 버튼. HomeTabPresenter가 리스너를 등록한다.</summary>
        public Button EnterStageButton  => _enterStageButton;

        /// <summary>왼쪽 화살표 버튼. HomeTabPresenter가 리스너를 등록한다.</summary>
        public Button LeftArrowButton   => _leftArrowButton;

        /// <summary>오른쪽 화살표 버튼. HomeTabPresenter가 리스너를 등록한다.</summary>
        ...
        public void Init(TMP_Text stageNumberText, Button enterStageButton, GameObject mailboxIcon,
                         Button leftArrowButton, Button rightArrowButton, GameObject stagePreviewPanel)
        {
            ...
            _stagePreviewPanel      = stagePreviewPanel;
        }
