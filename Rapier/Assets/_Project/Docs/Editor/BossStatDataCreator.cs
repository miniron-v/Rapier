...
namespace Game.Editor
{
    ...
    public static class BossStatDataCreator
    {
        ...
        {
            string path = $"Assets/_Project/ScriptableObjects/Enemies/Boss/{fileName}.asset";
        ...
        public static void SetupBossRushScene()
        {
            ...
            {
                var playerPrefab = AssetDatabase.LoadAssetAtPath<GameObject>("Assets/_Project/Prefabs/Player/Rapier_Player.prefab");
                GameObject playerGo;
        ...
        {
            // ── 프리팹 로드 ────────────────────────────────────────
            var titanPrefab        = AssetDatabase.LoadAssetAtPath<GameObject>("Assets/_Project/Prefabs/Boss/Titan_Boss.prefab");
            var specterPrefab      = AssetDatabase.LoadAssetAtPath<GameObject>("Assets/_Project/Prefabs/Boss/Specter_Boss.prefab");
            var berserkerPrefab    = AssetDatabase.LoadAssetAtPath<GameObject>("Assets/_Project/Prefabs/Boss/Berserker_Boss.prefab");
            var gravekeeperPrefab  = AssetDatabase.LoadAssetAtPath<GameObject>("Assets/_Project/Prefabs/Boss/Gravekeeper_Boss.prefab");
            var pyromancerPrefab   = AssetDatabase.LoadAssetAtPath<GameObject>("Assets/_Project/Prefabs/Boss/Pyromancer_Boss.prefab");
            var stormcallerPrefab  = AssetDatabase.LoadAssetAtPath<GameObject>("Assets/_Project/Prefabs/Boss/Stormcaller_Boss.prefab");
            var twinPhantomsPrefab = AssetDatabase.LoadAssetAtPath<GameObject>("Assets/_Project/Prefabs/Boss/TwinPhantoms_Boss.prefab");

            // ── StatData 로드 ──────────────────────────────────────
            var titanData        = AssetDatabase.LoadAssetAtPath<BossStatData>("Assets/_Project/ScriptableObjects/Enemies/Boss/TitanStatData.asset");
            var specterData      = AssetDatabase.LoadAssetAtPath<BossStatData>("Assets/_Project/ScriptableObjects/Enemies/Boss/SpecterStatData.asset");
            var berserkerData    = AssetDatabase.LoadAssetAtPath<BossStatData>("Assets/_Project/ScriptableObjects/Enemies/Boss/BerserkerStatData.asset");
            var gravekeeperData  = AssetDatabase.LoadAssetAtPath<BossStatData>("Assets/_Project/ScriptableObjects/Enemies/Boss/GravekeeperStatData.asset");
            var pyromancerData   = AssetDatabase.LoadAssetAtPath<BossStatData>("Assets/_Project/ScriptableObjects/Enemies/Boss/PyromancerStatData.asset");
            var stormcallerData  = AssetDatabase.LoadAssetAtPath<BossStatData>("Assets/_Project/ScriptableObjects/Enemies/Boss/StormcallerStatData.asset");
            var twinPhantomsData = AssetDatabase.LoadAssetAtPath<BossStatData>("Assets/_Project/ScriptableObjects/Enemies/Boss/TwinPhantomsStatData.asset");
