...
public class DocSyncTool : EditorWindow
{
    ...
    public static void SyncAllDocs()
    {
        ...
        // DesignDoc 변환
        string designDocMd = Path.GetFullPath(Path.Combine(DocsPath, "Rapier_Prototype_DesignDoc_v1.1.0.md"));
        string designDocDocx = Path.GetFullPath(Path.Combine(DocsPath, "Rapier_Prototype_DesignDoc_v1.1.0.docx"));
        ...
        {
            UnityEngine.Debug.LogWarning($"[DocSync] DesignDoc MD not found: {designDocMd}\n'Rapier/Docs/Create DesignDoc MD' 메뉴로 먼저 생성하세요.");
        }

        // PROJECT_GUIDELINES 변환
        ...
        {
            UnityEngine.Debug.LogWarning($"[DocSync] Guidelines MD not found: {guidelinesMd}");
        }
    ...
    // -------------------------------------------------------
    // 메뉴: Create DesignDoc MD (최초 1회 실행)
    // -------------------------------------------------------
    [MenuItem("Rapier/Docs/Create DesignDoc MD")]
    public static void CreateDesignDocMd()
    {
        string path = Path.GetFullPath(Path.Combine(DocsPath, "Rapier_Prototype_DesignDoc_v1.1.0.md"));
        ...
        EditorUtility.DisplayDialog("DocSync", "Rapier_Prototype_DesignDoc_v1.1.0.md 생성 완료!", "확인");
    }
    ...
    private static void ConvertWithPandoc(string inputMd, string outputDocx)
    {
        ...
        {
            UnityEngine.Debug.LogError($"[DocSync] Pandoc 실행 실패. PATH에 pandoc이 등록되어 있는지 확인하세요.\n{e.Message}");
        }
    }
